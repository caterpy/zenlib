...
__all__ = ['min_cut', 'min_cut_', 'min_cut_set',
           'min_cut_set_', 'UNIT_CAPACITY', 'WEIGHT_CAPACITY']
...
def min_cut_(G, sidx, tidx, capacity=UNIT_CAPACITY):
    ...
    **Returns**:
    ...
    residual_capacities = create_residual_digraph(
        residual_capacities, capacity)
    ...
    try:
        ...
        residual_capacities = ford_fulkerson(
            residual_capacities, s, t, capacity)
    except:
        return float('inf')
...
def get_path(G, s, t):
    ...
    shortest_path = z.algorithms.shortest_path.dijkstra_path(
        G, s, t, ignore_weights=True)[1]
