...
class CommunityTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.non_probabilistic = Community(
            0, self.G, set(range(self.NUM_NODES)))
    ...
    def test_assoc_prob(self):
        ...
        self.assertEqual(
            self.non_probabilistic.assoc_prob(self.NUM_NODES), 0.0)
        self.assertEqual(
            self.non_probabilistic.assoc_prob_(self.NUM_NODES), 0.0)
...
class CommunitySetTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cmnties = CommunitySet(
            self.G, fake_community_table, self.NUM_NODES / 2)
    ...
    def test_community_idx(self):
        ...
        self.assertRaises(
            ZenException, self.cmnties.node_community_indices_, self.NUM_NODES)
        self.assertRaises(
            KeyError, self.cmnties.node_community_indices, self.NUM_NODES)
    ...
    def test_share_community(self):
        ...
        for i in range(self.NUM_NODES):
            ...
            self.assertRaises(
                ZenException, self.cmnties.share_community_, i, self.NUM_NODES)
    ...
    def test_community(self):
        for i in range(self.NUM_NODES):
            ...
            self.assertEqual(com_idx.community_idx,
                             self.cmnties.node_community_indices_(i)[0])
            self.assertEqual(com_obj.community_idx,
                             self.cmnties.node_community_indices(i)[0])
    ...
    def test_community(self):
        for i in range(self.NUM_NODES):
            ...
            for comm in comms_idx:
                ...
                self.assertTrue(
                    comm.community_idx in self.cmnties.node_community_indices_(i))

            for comm in comms_obj:
                self.assertTrue(i in comm)
                self.assertTrue(
                    comm.community_idx in self.cmnties.node_community_indices(i))
