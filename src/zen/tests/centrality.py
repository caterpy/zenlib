...
class TestBetweennessCentrality(unittest.TestCase):
    ...
    def test_random_dir_weights(self):
        ...
        if not use_networkx:
            sys.stderr.write(
                'Skipping TestBetweenessCentrality.test_random_dir_weights due to missing networkx library\n')
            return
        ...
        # networkx.betweenness_centrality(Gnx,True,True)
        Rnx = networkx.betweenness_centrality(
            Gnx, normalized=True, weight='weight')
    ...
    def test_random_dir_noweights(self):
        ...
        if not use_networkx:
            sys.stderr.write(
                'Skipping TestBetweenessCentrality.test_random_dir_noweights due to missing networkx library\n')
            return
        ...
        # networkx.betweenness_centrality(Gnx,True,True)
        Rnx = networkx.betweenness_centrality(
            Gnx, normalized=True, weight=None)
    ...
    def test_random_udir_weights(self):
        ...
        if not use_networkx:
            sys.stderr.write(
                'Skipping TestBetweenessCentrality.test_random_udir_weights due to missing networkx library\n')
            return
    ...
    def test_random_udir_noweights(self):
        ...
        if not use_networkx:
            sys.stderr.write(
                'Skipping TestBetweenessCentrality.test_random_udir_noweights due to missing networkx library\n')
            return
    ...
    def test_brandes_betweenness_ud(self):
        ...
        self.G = G
        self.exact_weighted = {G.node_idx(0): 4.0, G.node_idx(1): 0.0, G.node_idx(
            2): 8.0, G.node_idx(3): 6.0, G.node_idx(4): 8.0, G.node_idx(5): 0.0}
