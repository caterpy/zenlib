...
class SCNTestCase(unittest.TestCase):
    ...
    def test_write2(self):
        ...
        scn.write(G, fname, num_node_props=1, num_edge_props=2,
                  node_data_fxn=node_data_fnc, edge_data_fxn=edge_data_fnc)
